...
def create_gui():
    ...
    def create_sql(item_name):
        ...
        # データベースに接続
        c = sqlite3.connect("database2.db")
...
def select_gui():
    ...
    def select_sql(start,end):
        ...
        #SELECT文の作成
        sql = """
        SELECT acc_date,item_name,get,pay
        ...
        for r in c.execute(sql):
            # 金額(r[2])を通貨形式に変換
            r = (r[0],r[1],"¥{:,d}".format(r[2]),"¥{:,d}".format(r[3]))
    ...
    tree.heading(3,text="入金")
    tree.heading(4,text="出金")
