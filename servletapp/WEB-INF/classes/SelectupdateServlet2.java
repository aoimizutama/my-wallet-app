...
@WebServlet("/SelectupdateServlet2")
public class SelectupdateServlet2 extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res)
      throws IOException, ServletException {
        ...
        ///selectupdate2.jspにフォワード
        RequestDispatcher rd = req.getRequestDispatcher("/selectupdate2.jsp");
        rd.forward(req, res);
    }
