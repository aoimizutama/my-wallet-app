...
@WebServlet("/CopydataServlet2")
public class CopydataServlet2 extends HttpServlet {
  public void doPost(HttpServletRequest req, HttpServletResponse res)
    throws IOException, ServletException {
      ...
      // acc_data3テーブルから選択されたidのデータを抽出
      String sql = "SELECT * FROM acc_data3 WHERE id = ?";
      ...
      //updatedata2.jspにフォワード
      RequestDispatcher rd = req.getRequestDispatcher("/updatedata2.jsp");
      rd.forward(req, res);
  }
