// データ登録後にデータベースから全てのデータを取得（銀行バージョン）
...
@WebServlet("/ShowAccdataServlet2")
public class ShowAccdataServlet2 extends HttpServlet {
    public void doPost(HttpServletRequest req, HttpServletResponse res)
      throws IOException, ServletException {
        ...
        //acc_data3テーブルからデータを抽出する
        String sql1 = "SELECT * FROM acc_data3 ORDER BY id DESC";
        ...
        //showaccdata2.jspにフォワード
        RequestDispatcher rd = req.getRequestDispatcher("/showaccdata2.jsp");
        rd.forward(req, res);
    }
