 ...
 * Generated at: 2023-11-03 12:49:46 UTC
...
public final class updatedata_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 int cash_after = (int)request.getAttribute("cash") - (int)request.getAttribute("get_money") + (int)request.getAttribute("out_money"); 
      ...
      out.write("    <h1>更新画面</h1>\r\n");
      out.write("        <form action=\"/kakeiboapp/UpdateServlet\" method=\"POST\">   <!-- 更新ボタンからUpdateServlet.javaへ　-->\r\n");
      out.write("            <label>id</label><input type=\"number\" name=\"id\" value=");
      out.print(request.getAttribute("id") );
      out.write("><br>\r\n");
      out.write("            <label>日付</label><input type=\"text\" name=\"date\" value=");
      out.print(request.getAttribute("acc_date") );
      out.write("><br>\r\n");
      out.write("            <label>内訳</label><input type=\"number\" name=\"item\" value=");
      out.print(request.getAttribute("item_code") );
      out.write("><br>\r\n");
      out.write("            <label>入金</label><input type=\"number\" name=\"getm\" value=");
      out.print(request.getAttribute("get_money") );
      out.write("><br>\r\n");
      out.write("            <label>出金</label><input type=\"number\" name=\"outm\" value=");
      ...
      out.write("><br>\r\n");
      out.write("            <label>残金</label><input type=\"number\" name=\"cash_before\" value=");
